...
Usage:
    python experiments/train_with_logging.py --name "baseline"
    python experiments/train_with_logging.py --name "more_epochs" --epochs 20
    python experiments/train_with_logging.py --name "higher_lr" --lr 5e-3
    python experiments/train_with_logging.py --name "more_data" --train_samples 3000
"""
